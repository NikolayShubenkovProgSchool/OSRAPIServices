...
@interface PSRCoreDataTableViewController : UIViewController <NSFetchedResultsControllerDelegate,UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic) BOOL isDownloadingDataForTable;
// Set to YES to get some debugging output in the console.
@property BOOL debug;
- (NSManagedObject *)itemAtIndexPath:(NSIndexPath*)indexPath;
    //reimplement this methods in subclass. Or in storyBoard as property with value
